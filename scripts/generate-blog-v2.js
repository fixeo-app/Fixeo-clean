...
function buildArticlePage(article, allArticles) {
  ...
  const articleLD = {
    ...
    'image': heroImg ? `https://www.fixeo.ma${heroImg}` : 'https://www.fixeo.ma/img/logo.png',
...
<head>
  ...
  <meta property="og:image" content="${heroImg ? `https://www.fixeo.ma${esc(heroImg)}` : 'https://www.fixeo.ma/img/logo.png'}">
  ...
  <meta name="twitter:image" content="${heroImg ? `https://www.fixeo.ma${esc(heroImg)}` : 'https://www.fixeo.ma/img/logo.png'}">
