...
function mapEngineResultToOutcome(engineResult, serviceCode, session) {
  ...
  if(svc){
    ...
    var units={tile_count:'carreau(x) de sol à remplacer',tile_area_m2:'m² de sol à carreler',surface_m2:'m² à nettoyer',painted_m2:'m² de murs à peindre',ceiling_m2:'m² de plafond',item_count:'élément(s)',ac_count:'climatiseur(s)',hours:'heure(s)',worker_count:'intervenant(s)'};
