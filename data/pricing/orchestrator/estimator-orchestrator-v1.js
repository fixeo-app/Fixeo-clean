...
function electricalBoundarySession(session, inputs, now) {
  var boundary=require('../engine/serrurerie-pilot-v1').guard(session.service_code,inputs,true)||require('../engine/climatisation-pilot-v1').guard(session.service_code,inputs,true)||require('../engine/electricity-pilot-v1').guard(session.service_code,inputs,true);
