...
t('12. CSS cache key is current (v2a-gateway — CSS unchanged in 10C.0)',
  ...
  estimationHtml.includes('fixeo-estimation-page-v1.css?v=fxestpage-v2e-canonical-gate'));
t('13. JS cache key updated to fxestpage-v2e-canonical-gate',
...
t('50. reservation.js?v=v1o-canonical-gate in reservation stack',
  pageJs.includes('reservation.js?v=v1o-canonical-gate'));
