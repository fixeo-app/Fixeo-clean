...
test('26. reservation.js key: v1o-canonical-gate (canonical after 10C.0.4)', function () {
  assert(idxSrc.includes('reservation.js?v=v1o-canonical-gate'), 'reservation JS key must be v1o-canonical-gate');
});
