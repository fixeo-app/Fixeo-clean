...
test('14.1 reservation.js key unchanged at v1m-estimator-copy', function () {
  assert.ok(idx.includes('reservation.js?v=v1m-estimator-copy'), 'reservation.js key unchanged');
});
