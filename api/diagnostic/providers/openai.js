...
Examples: small plumbing leak, gas appliance failure with no leak, a simple stable crack, HVAC failure, ordinary roof infiltration or heating/appliance failure alone are technical problems; a large explicitly controlled/manageable water leak, a blocked lock or worsening damage without an immediate threat are urgent technical problems; gas smell/leak, active flames/smoke/sparks, electric shock, water touching electrics, uncontrolled flooding, ongoing collapse or an explicit immediate danger are critical. A gas appliance is not itself evidence of a gas leak. A crack alone is not evidence of collapse. Absence of an active sign never certifies safety. Preserve critical signals from any source even when other evidence is lower risk.
