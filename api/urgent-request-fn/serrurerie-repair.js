...
const actions={serrurerie_repair_read:'read',serrurerie_repair_accept:'accept',serrurerie_repair_decline:'decline'};
module.exports=async function serrurerieRepair(body,res){
