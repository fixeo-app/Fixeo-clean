...
var VALID_SLUGS = [
  ...
  'menuiserie','peinture','maconnerie','nettoyage','carrelage',
  'jardinage','bricolage','demenagement','autre'
];
 ...
 */
if (body.action !== 'guest_lookup' && body.action !== 'plumbing_repair_read' && body.action !== 'electricity_repair_read') {
  var ip = String(
  ...
  if (['electricity_repair_read','electricity_repair_accept','electricity_repair_decline'].includes(body.action)) {
    return require('./electricity-repair')(body,res);
  }
