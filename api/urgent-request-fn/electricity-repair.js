...
const actions={electricity_repair_read:'read',electricity_repair_accept:'accept',electricity_repair_decline:'decline'};
module.exports=async function electricityRepair(body,res){
