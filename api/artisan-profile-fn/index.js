/*!
 * api/artisan-profile-fn/index.js — Vercel Serverless Function
 * SEO Phase 2A — Server-Rendered Artisan Profile (Foundation Recovery)
 *
 * Route:  GET /artisan/{public_slug}
 * Branch: fix/seo-foundation-reconciliation
 *
 * Isolation: Placed in api/artisan-profile-fn/ with its own package.json
 *   because api/package.json ("main":"server.js") prevents any sibling
 *   .js file in api/ from being registered as a standalone Vercel lambda.
 *   This is the same isolation pattern proven for api/lp-fn/ (Phase 3B).
 *   Original source: feat/seo-phase2a-ssr-profile-poc:api/artisan-profile.js
 *
 * Purpose:
