/**
 * fx-request-flow-v4.js — fxrf4-v5n
...
(function () {
  ...
  function _fireAnalytics(req, mode, duplicated) {
    try {
      window.dispatchEvent(new CustomEvent('fixeo:client-request-submit-success', {
        detail: { request: req, mode: mode, source: 'fxrf4-v5n',
  ...
  function _buildDOM() {
    ...
    /* Diagnostic */
    console.log('[fxrf4-v5n] DOM built. Header children:', head.childElementCount, '(expected 2: rafi-row, close)');
  }
  ...
  function _renderSuccess(saved) {
    ...
    if (head) {
      console.log('[fxrf4-v5n] Success rendered. mode=' + (st.mode) +
