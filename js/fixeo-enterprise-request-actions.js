...
(function (root, factory) {
  ...
  async function create(client,enterpriseId,input){
    ...
    var requestedAmount=input.requested_amount==null||input.requested_amount===''?null:Number(input.requested_amount);
    if(requestedAmount!==null&&(!Number.isFinite(requestedAmount)||requestedAmount<0)) throw new Error('INVALID_AMOUNT');
