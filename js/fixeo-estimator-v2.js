...
(function() {
  ...
  var PROMPT_LABELS = {
    ...
    moving_task: "Avez-vous besoin uniquement de manutention sur un même site, sans camion, transport, démontage ni remontage ?",
    moving_access: "Tout le parcours est-il dégagé, au rez-de-chaussée ou avec un ascenseur adapté aux objets, sans escalier à porter, et le véhicule accessible à proximité si nécessaire ?",
  ...
  function optionLabel(opt) {
    var labels = {
      ...
      MOVING_HANDLING_ONLY: "Oui, manutention sur place uniquement",
      MOVING_ACCESS_READY: "Oui, accès dégagé sans portage en escalier",
      MOVING_STANDARD_ITEMS: "Oui, cartons et meubles courants",
