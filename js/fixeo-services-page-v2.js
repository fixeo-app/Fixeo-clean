...
(function(){
 ...
 async function prepare(){
  ...
  for(const src of ['js/fixeo-estimator-config.js','js/fixeo-estimator-api-v1.js','js/fixeo-estimator-reservation-bridge-v1.js?v=7c9m4-continuity2','js/fixeo-ai-request-engine.js?v=aire-v1a','js/fixeo-rafi-language-v1.js?v=frl-v1a','js/fixeo-estimator-v2.js?v=rafi-back1','js/fixeo-estimation-voice-v1.js?v=mic-svg1','js/fixeo-discovery-v1.js?v=fd-services1'])await script(src);
 }
