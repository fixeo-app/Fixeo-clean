-- REVIEW ONLY — NOT APPLIED. Requires a new explicit Production authorization.
...
ORDER BY check_name
 ...
 IF failed IS NOT NULL THEN RAISE EXCEPTION 'S0 preflight failed: %', failed USING ERRCODE='P0001'; END IF;
END $s0_preflight$;
...
REVOKE MAINTAIN, REFERENCES, TRIGGER, TRUNCATE ON TABLE public.artisan_profiles FROM anon;
REVOKE MAINTAIN, REFERENCES, TRIGGER, TRUNCATE ON TABLE public.artisan_profiles FROM authenticated;
REVOKE MAINTAIN ON TABLE public.artisans FROM anon;
REVOKE MAINTAIN ON TABLE public.artisans FROM authenticated;
REVOKE MAINTAIN ON TABLE public.enterprise_accounts FROM authenticated;
REVOKE MAINTAIN ON TABLE public.enterprise_audit_events FROM authenticated;
REVOKE MAINTAIN, REFERENCES, TRIGGER, TRUNCATE ON TABLE public.missions FROM anon;
REVOKE MAINTAIN, REFERENCES, TRIGGER, TRUNCATE ON TABLE public.missions FROM authenticated;
REVOKE MAINTAIN, REFERENCES, TRIGGER, TRUNCATE ON TABLE public.notifications FROM anon;
REVOKE MAINTAIN, REFERENCES, TRIGGER, TRUNCATE ON TABLE public.notifications FROM authenticated;
REVOKE MAINTAIN, REFERENCES, TRIGGER, TRUNCATE ON TABLE public.payments FROM anon;
REVOKE MAINTAIN, REFERENCES, TRIGGER, TRUNCATE ON TABLE public.payments FROM authenticated;
REVOKE MAINTAIN, REFERENCES, TRIGGER, TRUNCATE ON TABLE public.quotes FROM anon;
REVOKE MAINTAIN, REFERENCES, TRIGGER, TRUNCATE ON TABLE public.quotes FROM authenticated;
REVOKE MAINTAIN, REFERENCES, TRIGGER, TRUNCATE ON TABLE public.service_requests FROM anon;
REVOKE MAINTAIN, REFERENCES, TRIGGER, TRUNCATE ON TABLE public.service_requests FROM authenticated;
...
ORDER BY check_name
 ...
 IF failed IS NOT NULL THEN RAISE EXCEPTION 'S0 postflight failed: %', failed USING ERRCODE='P0001'; END IF;
END $s0_postflight$;
COMMIT;
